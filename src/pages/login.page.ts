...
export class LoginPage extends BasePage {
  ...
  readonly loginHeader = this.page.locator(
    'h2:has-text("Login to your account")',
  );
  readonly emailAddressInput = this.page.locator(
  ...
  readonly invalidDataParagraph = this.page.locator(
  ...
  async fillUserData(userEmail: string, userPassword: string): Promise<void> {

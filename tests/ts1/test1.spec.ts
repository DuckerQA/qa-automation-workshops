...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Name' }).fill('maciej');
  await page.locator('form').filter({ hasText: 'Signup' }).getByPlaceholder('Email Address').click();
  await page.locator('form').filter({ hasText: 'Signup' }).getByPlaceholder('Email Address').fill('maciek12345@gmail.com');
  ...
  await expect(page.getByText('Logged in as maciej')).toBeVisible();
